...
expName = 'posttest_order_1'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'session': '001',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/lendlab/Desktop/SL/posttest_order_2_lastrun.py',
...
for thisTrial in trials:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    left_sound.setSound(l_sound_2, secs=1.5, hamming=True)
    left_sound.setVolume(1.0, log=False)
    right_sound.setSound(r_sound_2, secs=1.5, hamming=True)
